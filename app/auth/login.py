...
from .services import authenticate_user, create_access_token, get_current_active_user, create_refresh_token, \
...
async def login_for_access_token(
    ...
    * client_secret: **string**
    ...
    await user_refresh_token_update(db, user.username, refresh_token)
    return {
        "user": user,
        "role": user.role,
        "token_type": "bearer",
