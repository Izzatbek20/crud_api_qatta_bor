...
from app.schemas.article import ArticleResponse, ArticleCreatePayload, ArticleUpdatePayload, ArticleStatus
...
async def router_article_get_all(
    ...
    return await _service.get_all(status, page_params)
